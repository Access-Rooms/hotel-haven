...
export const reviews: Review[] = [
  {
    ...
    rating: 5,
    comment: 'Absolutely stunning property! The sea view from our room was breathtaking, and the staff went above and beyond to make our anniversary special.',
    date: '2024-01-15',
  ...
  },
  {
    ...
    rating: 5,
    comment: 'Best hotel experience in Goa. The infinity pool overlooking the ocean is a must-experience. Will definitely return!',
    date: '2024-01-10',
  ...
  },
  {
    ...
    rating: 4,
    comment: 'Beautiful resort with excellent amenities. The spa treatment was heavenly. Only wish the breakfast had more variety.',
    date: '2024-01-05',
  ...
  },
  {
    ...
    rating: 5,
    comment: 'The attention to detail is remarkable. From the welcome drink to the farewell gift, every moment felt curated for perfection.',
    date: '2023-12-28',
